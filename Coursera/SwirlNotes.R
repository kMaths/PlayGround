...
this_moment
this_moment <- update(this_moment, hours = 16, minutes =  54)
this_moment
?now
...
as.period(how_long)
#See 'Dates and Times Made Easy with lubridate' for info
#about instants, intervals, durations, and periods
stopwatch()
bye()